...
In.txt - 		file containing the environment code in the form of raster data (a DEM). This program reads in this data and it is used to display the environment with 
			which the agents will interact.
